...
1. Abra `/health`; o retorno esperado é `{"status":"ok"}`.
2. Use `/health/ready` apenas para diagnóstico de conexão com o banco; ele não
   deve ser o monitor periódico, para permitir que o Neon escale para zero.
3. Cadastre um usuário no site.
4. Confirme se o e-mail da Brevo chegou e valide a conta.
5. Faça login e cadastre uma fazenda.
6. Autorize um dispositivo e teste uma leitura IoT.
